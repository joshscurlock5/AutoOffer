...
$files     = @("whysell-easy.png","whysell-finance.png","whysell-tradein.png")
$OUT       = 256          # final square size
$MARGIN    = 0.10         # fraction of content size kept as padding on each side
$THRESHOLD = 244          # "content" if min(R,G,B) < this — catches the blue glyph, drops the white tile/bg
...
foreach ($f in $files) {
  ...
  $src = New-Object System.Drawing.Bitmap $bk   # crop from the pristine original
