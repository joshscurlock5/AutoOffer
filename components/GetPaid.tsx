  ...
  return (
    <Section className="bg-cream">
      <div className="mx-auto max-w-col wide:max-w-none">
        ...
        <div className="mt-10 grid items-stretch gap-8 wide:grid-cols-[1.4fr_1fr]">
          ...
          <div className="mx-auto hidden w-full max-w-md items-center rounded-3xl bg-slate-100 p-5 shadow-lift sm:p-6 wide:ml-auto wide:flex">
