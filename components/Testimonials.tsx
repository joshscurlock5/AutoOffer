...
import { Star, ExternalLink, GoogleG } from "./icons";
    ...
    <Section className="bg-white">
      <div className="mx-auto max-w-col wide:max-w-none">
        ...
        <p className="mt-4 max-w-2xl text-lg text-muted">
          We&apos;ve purchased more than {site.carsBought.toLocaleString("en-CA")} cars from customers and received a lot of
          great feedback. See what&apos;s behind our 5.0 star average review rating.
        </p>
