...
export function captureFirstTouch(): void {
  ...
  if (!read<Attribution>(ATTR_KEY)) {
    ...
    const attr: Attribution = {
      ...
      adDevice: p.get("device") || undefined,
      locPhysical: p.get("loc_physical_ms") || undefined,
...
export function parseAttribution(raw: unknown): Attribution | undefined {
  ...
  try {
    ...
    const a: Attribution = {
      ...
      keyword: S(o.keyword, 200),
      adDevice: S(o.adDevice, 40),
      locPhysical: S(o.locPhysical, 60),
      utmId: S(o.utmId, 120),
