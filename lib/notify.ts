...
// NOTE: inbound email attachments are NOT relayed as Telegram media anymore —
// pushing image bytes through the serverless webhook blew its response window
// (504s). The webhook posts a link to app/inbound/[emailId] instead, which
// shows the photos in the browser with fresh signed URLs per view.
