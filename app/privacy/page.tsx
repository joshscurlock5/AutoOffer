  ...
  const sections = [
    ...
    },
    {
      ...
      p: [
        ...
        "If you have contacted us, we may also upload a securely hashed list of contact details (email address, phone number, name) to Meta so we can show ads to you — for example, a reminder to finish your offer — or to people with similar characteristics. Meta cannot read the hashed values; it can only match them against its own users, and it uses them solely for that matching. You can opt out of this at any time by emailing us.",
